...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // Base mobile styles - transparent bg allows gradient to show through for glass effect
        "bg-transparent relative flex w-full flex-1 flex-col overflow-y-auto min-h-screen-mobile mobile-bg-gradient",
        // Desktop styles - solid background
        "md:bg-background md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 md:peer-data-[variant=inset]:h-[calc(100svh-1rem)]",
        className
      )}
      {...props}
    />
...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 p-2 pl-[10px] border-0", className)}
      {...props}
    />
  )
}

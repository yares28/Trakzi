...
const SIDEBAR_WIDTH = "17rem"  // Increased from 16rem now that rail is removed
    ...
    >
      ...
      >
        <div
          ...
          className="bg-sidebar group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col rounded-r-2xl group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm dark:ring-1 dark:ring-white/5"
        >
          {children}
        </div>
      </div>
...
function SidebarRail({ className, ...props }: React.ComponentProps<"div">) {
  // Removed toggle functionality - sidebar should only toggle via SidebarTrigger button

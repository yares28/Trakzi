...
function ChartCard({
  ...
  return (
    <m.div
      ref={ref}
      className="bg-card/50 border border-border/50 rounded-2xl overflow-hidden hover:border-primary/30 transition-all duration-300"
...
export function ChartCardsGrid() {
  return (

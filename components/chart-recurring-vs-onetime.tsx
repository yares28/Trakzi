...
RecurringVsOneTimeInfoTrigger.displayName = "RecurringVsOneTimeInfoTrigger"
...
const RecurringVsOneTimeChart = memo(function RecurringVsOneTimeChart({
  chartData,
  total,
  textColor,
  formatCurrency,
...
RecurringVsOneTimeChart.displayName = "RecurringVsOneTimeChart"

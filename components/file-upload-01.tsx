...
import { File, HelpCircle, Image as ImageIcon, Loader2, Trash2, Upload } from "lucide-react"
...
export type FileUpload01Lead = {
  id: string
  name: string
  imageUrl?: string | null
}

export interface FileUpload01Props {
  files: File[]
      ...
      <CardContent className="p-0">
        <div className="p-6 pb-4">
          <div className="flex justify-between items-start">
            <div>
              <h2 className="text-lg font-medium text-foreground">Import receipts</h2>
              <p className="text-sm text-muted-foreground mt-1">
                Drop receipt photos to update your grocery shopping insights.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="px-6">
          ...
          >
            ...
            <p className="text-sm font-medium text-foreground">Upload receipt images</p>
            <p className="text-sm text-muted-foreground mt-1">
              or,{" "}
              <label
                htmlFor="fileUpload"

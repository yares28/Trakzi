...
export const ChartErrorState = memo(function ChartErrorState({
  ...
  description = "Something went wrong loading this chart. Please refresh the page.",
  className,
}: ChartErrorStateProps) {
  return (
    <div className={cn("flex flex-col items-center justify-center text-center px-4 py-8 h-full", className)}>

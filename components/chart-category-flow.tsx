...
interface CategoryFlowInfoTriggerProps {
  forFullscreen?: boolean
  categoryControls?: ChartInfoPopoverCategoryControls
  data: Array<{ id: string; data: Array<{ x: string; y: number; percentage?: number }> }>
}

const CategoryFlowInfoTrigger = memo(function CategoryFlowInfoTrigger({
  forFullscreen = false,
  categoryControls,
  data,
...
const CategoryFlowFullChart = memo(function CategoryFlowFullChart({
  data,
  colorConfig,
  textColor,
  borderColor,
  getMonthAbbreviation,
}: CategoryFlowFullChartProps) {
  return (
    <ResponsiveAreaBump
      data={data}
...
CategoryFlowFullChart.displayName = "CategoryFlowFullChart"

interface CategoryFlowMobileChartProps {
  data: AreaBumpSerie[]
  colorConfig: string[]
  textColor: string
  borderColor: string
...
const CategoryFlowMobileChart = memo(function CategoryFlowMobileChart({
  data,
  colorConfig,
  textColor,
  borderColor,
  getMonthAbbreviation,
}: CategoryFlowMobileChartProps) {
  return (
    <ResponsiveAreaBump
      data={data}
...
CategoryFlowMobileChart.displayName = "CategoryFlowMobileChart"

interface CategoryFlowMobileLegendProps {
  data: AreaBumpSerie[]
  colorConfig: string[]
}

const CategoryFlowMobileLegend = memo(function CategoryFlowMobileLegend({
  data,
  colorConfig,
  ...
  return (
    <>
      <ChartFullscreenModal
        ...
        title="Spending Category Rankings"
        headerActions={<CategoryFlowInfoTrigger forFullscreen data={data} categoryControls={categoryControls} />}
      >
        <div className="h-full w-full">
          <CategoryFlowFullChart
            data={data}

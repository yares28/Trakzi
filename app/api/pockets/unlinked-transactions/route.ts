...
import type { CountryTransaction, UnlinkedTransactionsResponse } from '@/lib/types/pockets'

/**
 * GET /api/pockets/unlinked-transactions?search=coffee&limit=50
...
export async function GET(request: Request) {
    try {
        ...
        console.error('[Pockets Unlinked Transactions] Error:', error)

...
export async function GET() {
    try {
        ...
        console.error('[World Map Instances GET] Error:', error)
...
export async function POST(request: Request) {
    try {
        ...
        console.error('[World Map Instances POST] Error:', error)
...
/**
 * PATCH /api/world-map/instances?id=123
...
export async function PATCH(request: Request) {
    try {
        ...
        console.error('[World Map Instances PATCH] Error:', error)
...
/**
 * DELETE /api/world-map/instances?id=123
...
export async function DELETE(request: Request) {
    try {
        ...
        console.error('[World Map Instances DELETE] Error:', error)

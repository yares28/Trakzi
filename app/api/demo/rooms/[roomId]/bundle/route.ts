...
const MOCK_ROOM_BUNDLES: Record<string, RoomBundleData> = {
    "room-1": {
        ...
        recentTransactions: [
            { id: "tx-1", description: "February rent", total_amount: 1500, currency: "EUR", uploaded_by: "user_alice", uploader_name: "Alice C.", split_type: "equal", created_at: "2026-02-01T10:00:00Z", transaction_date: "2026-02-01" },
    ...
    "room-2": {
        ...
        recentTransactions: [
            { id: "tx-4", description: "Airbnb booking", total_amount: 800, currency: "EUR", uploaded_by: "user_charlie", uploader_name: "Charlie D.", split_type: "equal", created_at: "2026-02-20T10:00:00Z", transaction_date: "2026-02-20" },

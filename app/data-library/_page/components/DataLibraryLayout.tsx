...
export function DataLibraryLayout({
  children,
  isDragging,
  onDragEnter,
  onDragLeave,
  ...
  return (
    ...
    >
      ...
      <SidebarInset className="h-svh overflow-hidden flex flex-col">
        <SiteHeader />
        <div
          className="flex flex-1 flex-col relative overflow-hidden pt-[60px] md:pt-0"

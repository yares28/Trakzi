...
const features = [
  {
    ...
    description: "Fotografía cualquier ticket de supermercado, restaurante o tienda. Trakzi extrae la tienda, la fecha y el total automáticamente con OCR impulsado por IA.",
    benefits: ["Extracción con IA", "Sin introducción manual", "Funciona con cualquier ticket"],
    detailHref: "/es/escaner-tickets",
    detailLabel: "Ver cómo funciona el escáner",
    visual: (
  ...
  {
    badge: "Importar CSV",
    subtitle: "Privacidad Bancaria",
    title: "Importa Cualquier CSV Bancario. Ve tus Gastos Cobrar Vida.",
    description: "Sube cualquier extracto bancario en CSV. Trakzi normaliza los datos y genera más de 20 gráficos interactivos al instante. Sin conexión bancaria.",
    benefits: ["Compatible con cualquier banco del mundo", "Gráficos y análisis instantáneos", "Categorización automática con IA"],
    detailHref: "/es/importar-csv",
    detailLabel: "Ver cómo funciona la importación",
    visual: (
      <div className="relative w-full h-[500px] rounded-xl">
        <div className="absolute inset-0 overflow-hidden rounded-xl">
          <Image src="/orangeBackground.png" alt="" fill className="object-cover opacity-30" />
  ...
  },
  {
    ...
    subtitle: "Habitaciones Compartidas",
    title: "Divide Facturas. Comparte Costes. Sin Problemas.",
    description: "Crea habitaciones con amigos o compañeros de piso. Añade gastos compartidos, divídelos como quieras y ve quién debe a quién.",
    benefits: ["Balance en tiempo real", "División flexible", "Múltiples habitaciones"],
    detailHref: "/es/dividir-gastos",
    detailLabel: "Ver cómo funcionan los gastos compartidos",
    visual: (
      <div className="relative w-full h-[500px] rounded-xl">
        <div className="absolute inset-0 overflow-hidden rounded-xl">
          <Image src="/orangeBackground.png" alt="" fill className="object-cover opacity-30" />
  ...
  },
  {
    ...
    subtitle: "Tickets Inteligentes",
    title: "Sabe a Dónde Va tu Dinero del Supermercado.",
    description: "Escanea tickets de cualquier tienda. Controla gastos por tienda, categoría y semana. Toma el control de tu presupuesto de alimentación.",
    benefits: ["Escanea tickets de cualquier tienda", "Gastos por categoría", "Gráficos de tendencia semanal"],
    detailHref: "/es/gastos-supermercado",
    detailLabel: "Ver cómo funciona el control de supermercado",
    visual: (
      <div className="relative w-full h-[500px] rounded-xl">
        <div className="absolute inset-0 overflow-hidden rounded-xl">
          <Image src="/orangeBackground.png" alt="" fill className="object-cover opacity-30" />
  ...
  },
  {
    ...
    benefits: ["Pregunta cualquier cosa sobre tus gastos", "Detección automática de patrones", "Respuestas con gráficos"],
    detailHref: undefined,
    detailLabel: "Empieza a chatear con IA",
    visual: (
      <div className="relative w-full h-[500px] rounded-xl">
        <div className="absolute inset-0 overflow-hidden rounded-xl">
          <Image src="/orangeBackground.png" alt="" fill className="object-cover opacity-30" />
  ...
  },
  {
    ...
    detailHref: undefined,
    detailLabel: "Explora todos los tipos de gráficos",
    visual: (
  ...
  {
    badge: "Uso Global",
    subtitle: "Funciona en Todo el Mundo",
    title: "Compatible con Cualquier Banco. En Cualquier País.",
    description: "Desde España hasta EEUU, desde CaixaBank hasta Chase. Sube cualquier exportación CSV y Trakzi lo gestiona. Sin conexión bancaria.",
    benefits: ["Compatible con cualquier banco del mundo", "Sin compartir credenciales", "Privacidad ante todo"],
    detailHref: "/es/importar-csv",
    detailLabel: "Ver cómo funciona la importación",
    visual: (
      <div className="relative w-full h-[500px] rounded-xl">
      ...
      <section className="relative min-h-screen flex flex-col" suppressHydrationWarning>
        <div className="container mx-auto px-4 py-32 sm:py-48 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center relative">
            ...
            >
              Todas tus <strong>Finanzas.</strong> <br />
              <em className="italic">Un Solo Espacio.</em>
            </m.h1>
            <m.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="relative overflow-hidden pt-48 pb-96 px-4 z-10">
        ...
        <div className="container mx-auto max-w-2xl text-center relative z-10">
          ...
          <m.p
            ...
            viewport={{ once: true }}
          >
            Gratis para empezar. Sin tarjeta de crédito. Compatible con cualquier banco del mundo.
          </m.p>
          <m.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
